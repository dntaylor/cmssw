...
L1TCaloParamsESProducer::L1TCaloParamsESProducer(const edm::ParameterSet& conf)
{
  ...
  m_params_helper.setLayer1ECalScalePhiBins(conf.exists("layer1ECalScalePhiBins") ? conf.getParameter<std::vector<unsigned>>("layer1ECalScalePhiBins") : std::vector<unsigned>() );
  m_params_helper.setLayer1HCalScalePhiBins(conf.exists("layer1HCalScalePhiBins") ? conf.getParameter<std::vector<unsigned>>("layer1HCalScalePhiBins") : std::vector<unsigned>() );
  m_params_helper.setLayer1HFScalePhiBins  (conf.exists("layer1HFScalePhiBins")   ? conf.getParameter<std::vector<unsigned>>("layer1HFScalePhiBins")   : std::vector<unsigned>() );
